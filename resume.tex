...
\end{center}
% \section*{Purpose}
IT Professional with a strong background in computer hardware, operating system, and network administration. Looking for full-time employment in cybersecurity. Graduating from WWU in June 2024. $\mid$ CompTIA Certifications: A+, Network+, Security+
% % Section 2: Experience
\section*{Experience}
% Element
\topLevelItem{Linux Systems Administrator (Student Employee)}{Western Washington University}{Bellingham, WA}{2021 — Present}
...
\section*{Education}
% Element
\topLevelItem{Computer Science and Society, BA and Minor in Computer Science}{Western Washington University}{Bellingham, WA}{Sept 2020 — June 2024 (Expected)}
