...
\begin{document}
    ...
    \section*{Projects}
        ...
        \topLevelProjectItem{Home Lab}{{}} %\href{https://nefortner.com/homelab}{nefortner.com/homelab}
            \lowLevelItem{Proxmox VM cluster: self-hosted DNS with domain-filtering, isolated malware analysis lab, remote development environment, file storage system, media server appliances, CTF images, various game servers; external access via TailScale, docker for software management}
