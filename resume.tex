...
% Header
\begin{center}
	% Info + icons beside nameCould not find definition for \lowLe
	...
	\alignicon\quad\href{https://nefortner.com}{ }
    \hfill % Website
...
\end{center}
% \section*{Purpose}
IT Professional with a strong background in computer hardware, operating system, and network administration. Looking for full-time employment in cybersecurity. $\mid$ CompTIA Certifications: A+, Network+, Security+
% % Section 2: Experience
\section*{Experience}
% Element
\topLevelItem{Systems Administrator}{South Carolina Department of Mental Health (SCDMH)}{Aiken, SC}{2024 — Present}
\lowLevelItem{Manage and maintain all systems for the Aiken Barnwell Mental Health Center for SCDMH}
\lowLevelItem{Imaging machines, installing software, and managing active directory}
\lowLevelItem{Prepare disaster plans for the center}
\topLevelItemEnd
\topLevelItem{Linux Systems Engineer (Student Employee)}{Western Washington University}{Bellingham, WA}{2021 — 2024}
\lowLevelItem{Managed and maintained WWU Housing Department Linux servers}
\lowLevelItem{Led a major migration of the housing department’s servers from vCenter to Azure to consolidate softwares}
\topLevelItemEnd
% Element
...
\lowLevelItem{Prepared technical documentation and drafted reports to facilitate event organization}
\topLevelItemEnd
...
\section*{Education}
% Element
\topLevelItem{Computer Science and Society, BA and Minor in Computer Science}{Western Washington University}{Bellingham, WA}{Sept 2020 — June 2024}
% \lowLevelItem{Multi-Disciplinary Studies Major with specialization in Computer Science and Cybersecurity}
\lowLevelItem{Relevant coursework: Cyber Warfare, Database Systems, Web Scripting, Object-Oriented Design}
