...
\lowLevelItem{Managed and maintained all systems for the Aiken Barnwell Mental Health Center for SCDMH}
\lowLevelItem{Imaged machines, installed software, and managed active directory}
\lowLevelItem{Prepared disaster plans for the center}
\topLevelItemEnd
\topLevelItem{Linux Systems Administrator (Student Employee)}{Western Washington University}{Bellingham, WA}{2021 — 2024}
