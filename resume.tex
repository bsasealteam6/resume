...
\begin{document}
    ...
    \section*{Experience}
        % Element
        \topLevelItem{Sever Admin Student Employee}{Western Washington University}{Bellingham, WA}{2021 - Present}
        ...
        \topLevelItemEnd
        %Element
        \topLevelItem{Design Interaction Intern}{NASA's Jet Propulsion Laboratory}{La Canada Flintridge, CA}{Summer 2016}
